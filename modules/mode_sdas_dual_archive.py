...
class MODE_SDAS_DUAL_ARCHIVE:
    ...
    注意：本文件不包含 PIC/DPIC，也不包含子空间自适应增删，
    适合用于消融实验：MODE-SDAS + Dual Archive。
    """

    def __init__(self, problem, pop_size=100, generations=100,
                 Nsub=21, L=7, CR=0.8, F=0.35,
                 archive_prob=0.15,
                 feasible_archive_size=100,
                 infeasible_archive_size=100,
                 ref_front_file=None,
                 execute_prob=0.15):
...
# 兼容性别名，可按需导入
MODE_SDAS_ARCHIVE = MODE_SDAS_DUAL_ARCHIVE
